...
"""
Модуль-парсер поступающих от пользователя сообщений. В процессе парсинга выражение имеет древообразную структуру,
которая в конечном результате преобразовывается в строку, удобную для вычисления в модуле calc.py. Парсинг 
